 ...
 const petik = '```'
 const nmr = '+'
const helpmenu = (wit,wita,wib,tampilTanggal, _Elite, tampilHari , limitawal, role, premi, sender, botname,pushname, prefix, wa_version, mcc, mnc, os_version, device_manufacturer, device_model ) => {
	return`╭─❒ *INFO BOT* 
